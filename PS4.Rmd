...
Tweet_wordcloud <- wordcloud(words = TDMTweets$word, freq = TDMTweets$freq, min.freq = 3, max.words = 50, random.order = TRUE, random.color = TRUE, rot.per = .25, colors = kovesi.rainbow(50))
