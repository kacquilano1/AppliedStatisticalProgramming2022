...
#6. Create word-cloud
#create pdf for word-cloud.
pdf(file = "./wordcloud.pdf")
#install.packages("pals") for color palatte
library(pals)
...
wordcloud(words = TDMTweets$word, freq = TDMTweets$freq, min.freq = 3, max.words = 50, random.order = TRUE, rot.per = .25, colors = kovesi.rainbow(50))
#save the word-cloud to the repository
dev.off()
