...
#door has value of 1, 2, or 3
door <- 1

#Turn it into a class called "door"
class(door) <- "door"

#Test door object for correct value and class
door
...
#Test this function
#Create an object a, with the value of 3
a <- 3
...
validate_door(DoorA)
validate_door_integer(DoorA)
#Test PlayGame method on the Door_1 object created
PlayGame(DoorA)
