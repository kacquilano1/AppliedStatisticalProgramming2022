...
#Test PlayGame method with Door. If the random prize matches the value of the Door object, then the function will print congrats message. If it does not match, the function will print sorry message.
#For example: If Door in question 1 was chosen to have a value of 1, then PlayGame will print the congrats message if the random prize matches 1. If the random prize is 2 or 3, then the sorry message will print
PlayGame(Door)
