...
#Test PlayGame method with object ContestantDoor. If the random prize matches the value of the ContestantDoor object, then the function will print congrats message. If it does not match, the function will print sorry message.
#For example: If ContestantDoor in question 1 was chosen to have a value of 1, then PlayGame will print the congrats message if the random prize matches 1. If the random prize is 2 or 3, then the sorry message will print
...
#Create a validator function, which will verify that the Door object is an integer of the correct value range
...
validate_door_integer <- function(x){
  ...
  #verify that the input is within the correct range of values
  #verify that the input is between 1 and 3
  #if the input is less than 1
  if(x < 1) {
    #throw an error message
    stop("Object is not within the correct range")
  }
  ...
  #if it is in the correct form, a whole number between 1 and 3, print an affirmation message
  else { print("Yes, this is in the correct type and ranger")
  }
